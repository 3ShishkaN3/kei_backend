...
*   **WebSocket с ИИ**: Модуль `material_service/consumers.py` реализует WebSocket-соединение с Google Gemini Live API для голосового взаимодействия.
*   **Celery**: Планировщик задач для фоновых операций.
